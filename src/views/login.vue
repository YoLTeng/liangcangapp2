<template>
  <div class="login">
    ...
    <div class="login-box4">
      <van-field v-model="tel" type="tel" placeholder="请输入手机号"  input-align="left"/>
    </div>
    ...
    <div class="login-box6">
      <van-field v-model="text" type="tel" placeholder="6位验证码" input-align="left"/>
    </div>
...
.login .login-box3 .login-box3-font p {
  font-size: 13px;
  color: white;
}
.login .login-box4{
